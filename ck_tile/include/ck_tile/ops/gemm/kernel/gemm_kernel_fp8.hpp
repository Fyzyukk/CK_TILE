...
struct GemmHostArgsWithScales
{
    CK_TILE_HOST GemmHostArgsWithScales() = default;
    CK_TILE_HOST GemmHostArgsWithScales(const void* a_ptr_,
                                        const void* b_ptr_,
...
template <index_t NumDTensor = 0>
struct GemmKernelArgsWithScales
{
...
struct GemmKernelWithScales
{
    ...
    using KernelArgs = GemmKernelArgsWithScales<DsLayout::size()>;
    ...
    {
        using Kernel      = GemmKernelWithScales<TilePartitioner, GemmPipeline, EpiloguePipeline>;
